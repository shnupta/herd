...
- [x] Session grouping — group by git root (auto) with custom override (`g` key)
- [x] Collapsible groups (`space`) — collapsed groups show header as navigable row with aggregate state dot
